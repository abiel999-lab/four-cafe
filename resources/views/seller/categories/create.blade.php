<x-seller-layout title="Tambah Kategori - FOUR">
<div class="text-xl font-bold mb-4">Tambah Kategori</div>

<div class="rounded-2xl bg-white/70 border border-black/10 p-4 max-w-xl">
    <form method="POST" action="{{ route('seller.categories.store') }}" class="flex flex-col gap-3">
        @csrf
