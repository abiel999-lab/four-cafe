...
<head>
    ...
    <title>Lupa Password - FOUR Cafe & Coffee</title>
        ...
        <section class="auth-shell">
            <div class="auth-card">
                <div class="brand">
                    ...
                    <div class="brand-kicker">Reset Password</div>

                    <h1 class="auth-title">Lupa password?</h1>

                    <p class="auth-subtitle">
                        Masukkan email akun seller kamu. Kami akan mengirimkan link untuk membuat password baru.
                    </p>
                </div>
